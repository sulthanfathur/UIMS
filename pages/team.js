    ...
    <main>
      ...
      <div className="container my-5 px-5">
        ...
        <div className="mt-5 mb-5 desc">
          We are motorsport team that was founded by Universitas Indonesia
          students who are interest, talented, and innovative in automotive
          sector, especially in karts, electric motorcycle, and motorsports.
        </div>
      </div>
      ...
      <div className="BoxGrid_wrapper py-4">
        <div className="BoxGrid_content">
          <div className="mx-4">{getTeam()}</div>
        </div>
      </div>

      <a
        href={`team/gokart`}
        class="text-light splitbanner_wrapper gokart_team_img team_image-properties"
      >
        <div class="gokart_ev_banner_item">
          ...
          <div class="splitbanner_content-media"></div>
        </div>
      </a>

      <a
        href={`team/ev`}
        class="text-light splitbanner_wrapper ev_team_img team_image-properties"
      >
        <div class="gokart_ev_banner_item">
          <div class="splitbanner_content-transparent">
            <div class="splitbanner_content-inside">
              ...
              <br></br>
              <a href={`team/ev`} class="text-light btn btn-outline-light btn">
                DISCOVER MORE
              </a>
            </div>
          </div>
      ...
      <a
        href={`team/marketing`}
        class="text-light splitbanner_wrapper marketing_team_img team_image-properties"
      >
        <div class="gokart_ev_banner_item">
          <div class="splitbanner_content-transparent">
            <div class="splitbanner_content-inside">
