    ...
    <div className="dark-mode">
        <div id="bannerimage">
            <div className="col-md-5 p-lg-5">
                <p className="font-weight-normal slogan">OUR MISSION:</p>
                <h1 className="display-5 slogan">
                    CREATE GROUNDBRAKING INNOVATION AND START INSPIRE PEOPLE.
                </h1>
                <p className="lead font-weight-normal slogan">"DON'T HESITATE, JUST START."</p>
            </div>
        </div>
