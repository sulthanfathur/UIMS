    ...
    <div className="dark-text">
      ...
      <div className="bg-darkgrey row flex-md-equal w-100 ml-0 md-3">
        <div className="m-3 p-3 mr-5">
          <div className="ml-5 flex-column position-static">
            ...
            <Link to={`/news`} className="btn btn-outline-light btn-lg ml-3">
              More News
            </Link>
          </div>
        </div>
      ...
      >
        <div className="flex text-center align-self-center">
          ...
          <Link
            to="/about"
            className="text-light btn btn-outline-light btn my-4"
          >
            Read More
          </Link>
        </div>
      ...
      <a
        href={`team`}
        class="text-light splitbanner_wrapper team_image-properties home_team_img"
      >
        <div class="gokart_ev_banner_item">
          <div class="splitbanner_content-transparent">
            <div class="splitbanner_content-inside">
              ...
              <br></br>
              <a href={`team`} className="text-light btn btn-outline-light btn">
                DISCOVER MORE
              </a>
            </div>
          </div>
